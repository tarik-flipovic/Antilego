...
- `original_collector/` — the original public-market snapshot collector and family definitions.
- `experiments/` — early WebSocket and order-book experiments.
- `historical_data/` — the original 132-snapshot dataset and market-family spreadsheets.
- `research/` — notebooks, analysis scripts, proposals, recovered versions, and original archives.
- `published_outputs/` — completed figures, reports, and exported analysis.
- `records/` — briefs, build plans, provenance manifests, and recovery verification.
